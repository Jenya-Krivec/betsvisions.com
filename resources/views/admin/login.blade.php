        ...
        <div class="w-80 border-2 border-gray-200 rounded-md container registerContainer mx-auto mainContainer my-2 flex flex-col justify-center p-5">
            <div>
                ...
                <form method="POST" action="{{ route('admin.login') }}" autocomplete="off">
                    ...
                    <div class="form-group row relative my-6">
                        <div class="col-md-6">
                            <button type="submit" class="w-full bg-violet-500 text-white px-4 py-2 rounded-lg hover:bg-white hover:text-black border-2 border-violet-500 transition delay-150 duration-300 ease-in-out cursor-pointer">Login</button>
                        </div>
                    </div>
                </form>
            </div>
