<div class="relative border-b-2 border-gray-200">
    <div class="flex items-center text-white bg-violet-500 rounded-full cursor-pointer transition-all duration-500 absolute -bottom-3 -left-4 hidden add-after" data-id="{{$id}}" title="Add component after Quick info">
