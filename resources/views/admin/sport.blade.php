...
@section('content')
    <main class="pt-24">
        ...
        <form action="{{ route('admin.storeSports') }}" method="POST" enctype="multipart/form-data" class="flex justify-center items-center flex-col form">
            ...
            <span class="flex items-center justify-center self-center text-white bg-violet-500 rounded-full h-6 w-6 transition-all duration-500 mb-2 mx-auto cursor-pointer hover:bg-white hover:text-black border-2 border-violet-500 add-sport" data-id="{{$sport['id']}}" title="Add Sport">+</span>
        </form>
    </main>
