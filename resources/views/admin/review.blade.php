...
@section('content')
    <main class="bg-gray-100 font-serif">
                ...
                <div class="mx-auto flex justify-center sm:justify-start items-center flex-col sm:flex-row px-4 pt-20">
                    ...
                    <div class="flex justify-between flex-col sm:rounded-md lg:pl-10 lg:pr-2">
                        <div class="text-white mx-4">
                            <h1 class="text-lg sm:text-2xl pl-1 font-bold border-l-8 border-white text-white">{{trans('review.Review', ['bookmaker' => $bookmaker['name']])}}</h1>
                        </div>
                        ...
                        <div class="flex flex-col justify-around flex-shrink-0 self-stretch rounded-md p-2 mx-1 md:mx-auto">
                            <div class="flex justify-center items-center">
                                <span data-url="{{$bookmaker['url']}}" class="h-10 w-36 text-sm text-white rounded-md border-2 border-white hover:bg-white hover:text-black flex justify-center items-center cursor-pointer transition-all duration-500 shadow-gray-400">@lang('review.Claim') &#8594;</span>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col justify-around flex-shrink-0 self-stretch rounded-md p-2 animate-list" id="animList">
                        <p class="text-center text-white">@lang('review.Contents')</p>
                        <?php $index = 1; ?>
        ...
        <div id="add-section" class="fixed border-2 border-violet-500 bg-white rounded-md flex justify-center items-center -left-52 p-2 flex-col bottom-1/2 transition-all duration-500 z-40" style="transform: translateY(50%);">
            ...
            <button class="w-full text-white border-2 border-violet-500 bg-violet-500 hover:bg-white hover:text-black text-xs rounded-full flex justify-center items-center cursor-pointer transition-all duration-500 p-2 my-1" value="Info">Add Quick info</button>
        </div>
    </main>
    ...
    <script defer type="text/javascript" src="{{ asset('js/review/contents.js').'?v='.filemtime('js/review/contents.js') }}"></script>
