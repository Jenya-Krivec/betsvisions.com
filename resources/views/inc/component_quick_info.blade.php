<div class="border-violet-500 border-t-2 mb-4" id="quick-info">
    ...
    @endif
    <div class="w-full flex justify-center items-center p-2 py-4 bg-white border-violet-500 border-b-2 mx-auto" style="max-width: 1200px">
    ...
    <div class="w-full flex sm:hidden justify-center items-center p-2 py-4 bg-white border-violet-500 border-b-2 mx-auto" style="max-width: 1200px">
        <div class="flex sm:justify-end items-center sm:w-48 flex-shrink-0 justify-center">
