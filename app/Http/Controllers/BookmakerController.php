    ...
    */
    ...
    public function store(Request $request, string $key)
    {
        $request->validate([
            ...
            'bonus_label_1_en' => 'string|required|min:2|max:250',
            'bonus_label_2_en' => 'string|required|min:2|max:250',
            'bonus_label_1_es' => 'string|required|min:2|max:250',
            'bonus_label_2_es' => 'string|required|min:2|max:250',
            'bonus_label_1_fr' => 'string|required|min:2|max:250',
            'bonus_label_2_fr' => 'string|required|min:2|max:250',
            'bonus_label_1_pt' => 'string|required|min:2|max:250',
            'bonus_label_2_pt' => 'string|required|min:2|max:250',
