...
class ProsCons {
    ...
    add(id){
        const row = '' +
            ...
            '    <div class="flex items-center text-white bg-violet-600 rounded-full cursor-pointer transition-all duration-500 absolute -bottom-3 -left-4 add-after hidden" onclick="new AddSection().addComponent({target: this})" data-id="'+(id+1)+'" title="Add component after Pros &amp; Cons">\n' +
