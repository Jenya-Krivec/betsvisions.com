...
class Picture {
    ...
    add(id) {
        const row = '' +
            ...
            '               <input name="'+(id+1)+'-img400-en" type="file" accept="image/*" class="mt-2 text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:violet-500 file:text-white">\n' +
            '           </div>\n' +
            '       </div>\n' +
            '    </div>\n' +
            '</div>';
